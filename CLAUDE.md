...
- **DISCLOSED, MEASURED, NOT FIXED — the river half is a DIFFERENT defect, and it is a WIDTH
  ...
  **order 1 — map 155 m vs town 17 m (9.1×); order 2 — 452 vs 24 (18.8×); order 3 — 764 vs 31
  (24.7×)**. Left for its own version **because adopting the map's number would put a 764 m river
  through a 187 m village** — which of the two is right is a calibration with its own measurement.
