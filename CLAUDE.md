...
node tests/perf/probe_worldreset.js A.html  # v2.44 all five world-construction paths: no inherited state; a resolution change rescales rather than abandons
