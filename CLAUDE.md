...
node tests/perf/probe_riverfill.js A.html # v2.60 a river must not break into parts: walks every main stem cell by cell and asks whether the painted water is 4-CONNECTED from one chain cell to the next (8-connectivity is free on a D8 chain and says nothing)
