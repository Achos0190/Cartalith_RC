...
```bash
tests/run.sh                        # newest Gen1 file: extract engine → node --check → 1192-assertion suite (exports ENGINE_SRC_PATH for the v2.47 worker-list check)
