...
Open the newest **`Cartalith Gen1 v*.html`** (currently **`Cartalith Gen1 v1.06.html`**) in a
...
| Path | What it is |
|------|------------|
| `Cartalith Gen1 v1.06.html` | **The tool.** Current version |
| `Cartalith Gen1 v0.57/v0.6/v0.61…v1.05.html` | Previous versions (kept, frozen) |
