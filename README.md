...
Open the newest **`Cartalith Gen1 v*.html`** (currently **`Cartalith Gen1 v0.78.html`**) in a
...
| Path | What it is |
|------|------------|
| `Cartalith Gen1 v0.78.html` | **The tool.** Current version |
| `Cartalith Gen1 v0.57/v0.6/v0.61…v0.77.html` | Previous versions (kept, frozen) |
...
```bash
tests/run.sh                                 # newest Gen1 file → 903-assertion headless suite
